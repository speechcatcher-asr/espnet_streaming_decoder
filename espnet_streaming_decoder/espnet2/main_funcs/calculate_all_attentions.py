...
from espnet_streaming_decoder.espnet2.gan_tts.jets.alignments import AlignmentModule
from espnet_streaming_decoder.espnet2.train.abs_espnet_model import AbsESPnetModel
from espnet_streaming_decoder.espnet.nets.pytorch_backend.rnn.attentions import (
    AttAdd,
    AttCov,
    AttCovLoc,
    AttDot,
